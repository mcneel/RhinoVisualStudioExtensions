// Rhino.1EventWatcher.h
//

#pragma once

// CMyRhino__1EventWatcher
// See Rhino.1EventWatcher.cpp for the implementation of this class.
//

class CMyRhino__1EventWatcher : public CRhinoEventWatcher
{
public:
  CMyRhino__1EventWatcher();
